        ...
        <header class="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-sm shadow-sm border-b border-white/10">
            <nav class="container mx-auto px-6 lg:px-8 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="px-5 py-2 rounded-lg bg-gradient-to-r from-nepal-blue to-nepal-purple text-white font-medium hover:shadow-lg hover:shadow-blue-500/30 transition-all hover:scale-[1.03]">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="px-5 py-2 text-[#1b1b18] dark:text-[#EDEDEC] font-medium hover:text-nepal-blue dark:hover:text-nepal-purple transition-colors">
                            Log in
                        </a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="px-5 py-2 rounded-lg bg-gradient-to-r from-nepal-blue to-nepal-purple text-white font-medium hover:shadow-lg hover:shadow-blue-500/30 transition-all hover:scale-[1.03]">
                                Register
                            </a>
                        @endif
                    @endauth
        ...
        Popular searches: <span class="text-white/90">Everest Base Camp, Pashupatinath, Pokhara</span>
            ...
            <div class="pt-6 flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#explore" 
                   ...
                   class="px-8 py-3.5 bg-white text-[#1b1b18] font-semibold rounded-full hover:bg-gray-100 hover:shadow-lg transition-all duration-300 hover:scale-[1.03] flex items-center justify-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="#gallery" 
                   ...
                   class="px-8 py-3.5 border-2 border-white text-white font-semibold rounded-full hover:bg-white/10 hover:shadow-lg transition-all duration-300 hover:scale-[1.03] flex items-center justify-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <section id="about" class="py-20 bg-white dark:bg-[#0a0a0a]">
            <div class="container mx-auto px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <h2 class="text-4xl md:text-5xl font-bold text-center mb-6 font-heading">Nepal's Natural & Cultural Wonders</h2>
