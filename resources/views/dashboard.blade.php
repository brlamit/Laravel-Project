    ...
    <div class="mt-2 text-lg text-white  text-center">
        Popular searches: <span class="text-white/90">Everest Base Camp, Pashupatinath, Pokhara</span>
                    ...
                    <div class="pt-2 flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="{{ route('gallery') }}" class="px-8 py-3.5 border-2 border-white text-white font-semibold rounded-full hover:bg-white/10 hover:shadow-lg transition-all duration-300 hover:scale-[1.03] flex items-center justify-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
